...
export default function WebDesignDiscoveryPage() {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        data.append("_form_source", "web-design-discovery");
        ...
        if (step === 1) {
            try {
                ...
                if (emailEl?.value && nameEl?.value) {
                    ...
                    partialData.append('_form_source', 'incomplete-web-design-discovery-lead');
                        ...
                        {status !== "success" && (
                            <div className="mb-12 max-w-xl mx-auto">
                                <div className="flex justify-between items-center text-[10px] uppercase tracking-[0.2em] text-slate-500 font-bold mb-3">
                                    <span className={step >= 1 ? "text-cyan-400" : ""}>1. About You</span>
                                    <span className={step >= 2 ? "text-cyan-400" : ""}>2. Brand & Vibe</span>
                                    <span className={step >= 3 ? "text-cyan-400" : ""}>3. Features & Scope</span>
                                    <span className={step >= 4 ? "text-cyan-400" : ""}>4. Budget & Support</span>
                                </div>
                                <div className="h-1 bg-white/5 rounded-full overflow-hidden">
                                    <motion.div className="h-full bg-cyan-400" animate={{ width: `${(step / 4) * 100}%` }} transition={{ duration: 0.3 }} />
                                </div>
                            </div>
                        )}
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                {step === 2 && (
                                    <motion.div id="step-2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                                        ...
                                        <FormSection icon={Palette} title="Design Preferences" delay={0.05}>
                                            <div className="space-y-3">
                                ...
                                {step === 3 && (
                                    <motion.div id="step-3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                                        <FormSection icon={LayoutGrid} title="Functionality & Features">
                                            <div className="space-y-3">
                                        ...
                                        <FormSection icon={FileText} title="Pages & Structure" delay={0.05}>
                                            <div className="space-y-3">
                                        ...
                                        <FormSection icon={Wrench} title="Content & Technical Readiness" delay={0.1}>
                                            <div className="space-y-2">
                                ...
                                {step === 4 && (
                                    <motion.div id="step-4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                                        ...
                                        <FormSection icon={Clock} title="Timeline & Investment" delay={0.05}>
                                            <div className="space-y-2">
                                        ...
                                        <FormSection icon={HeartHandshake} title="Ongoing Support" delay={0.1}>
                                            <div className="space-y-2">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    {step < 4 ? (
                                        <button
                                            type="button"
                                            onClick={nextStep}
                                            className="flex-grow py-5 bg-white text-black font-black rounded-2xl flex items-center justify-center gap-3 hover:bg-cyan-400 hover:text-white focus:scale-[0.98] transition-all uppercase tracking-widest text-sm"
                                        >
                                            Continue ➔
                                        </button>
                                    ) : (
                                        <motion.button
                                            type="submit"
                                            disabled={disabled}
                                            className="flex-grow py-5 bg-white text-black font-black rounded-2xl flex items-center justify-center gap-3 hover:bg-cyan-400 hover:text-white focus:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed transition-all group text-sm uppercase tracking-widest"
                                        >
                                            {disabled ? (
                                                <>
