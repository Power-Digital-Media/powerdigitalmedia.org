                ...
                <div className="container px-4 mx-auto"><div className="max-w-3xl mx-auto">
                    ...
                    {status === "success" ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <FormSection icon={Radio} title="About Your Podcast" delay={0.05}>
                                <div className="space-y-2">
                            ...
                            <FormSection icon={Headphones} title="Production Needs" delay={0.1}>
                            ...
                            <FormSection icon={Calendar} title="Schedule & Availability" delay={0.15}>
                                <div className="space-y-2">
                            ...
                            <FormSection icon={Sparkles} title="Distribution & Growth" delay={0.2}>
                                <div className="space-y-3">
                            ...
                            <FormSection icon={DollarSign} title="Investment" delay={0.25}>
                                <div className="space-y-3">
                            ...
                            <motion.button type="submit" disabled={disabled} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="w-full py-5 bg-white text-black font-black rounded-2xl flex items-center justify-center gap-3 hover:bg-purple-400 hover:text-white focus:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed transition-all group text-lg uppercase tracking-widest">
                                {disabled ? (<><div className="w-5 h-5 border-2 border-black/30 border-t-black rounded-full animate-spin" />Submitting...</>) : (<>Launch Show Brief<Send className="w-5 h-5 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" /></>)}
                            </motion.button>
                        </form>
                    )}
                </div></div>
