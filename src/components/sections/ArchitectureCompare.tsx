        ...
        <section className="py-32 relative bg-background overflow-hidden border-t border-white/5">
            ...
            <div className="container relative z-10 px-4 mx-auto">
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-red-950/20 bg-noise flex flex-col justify-center p-8 md:p-16 lg:p-20">
                        <div className="w-[45%] md:w-[42%] max-w-[400px]">
                            <h3 className="text-2xl md:text-4xl font-black text-red-500 mb-2 uppercase opacity-40">Traditional Web</h3>
                            <h4 className="text-lg font-bold text-red-400/80 mb-6 border-b border-red-500/20 pb-4">Theme-Based / WordPress</h4>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <strong className="block text-red-300 mb-1">Server-Side Render Delay</strong>
                                        <p className="text-sm text-red-200/50">Each page visit queries a slow database, leading to 3+ second load times.</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4">
                                    <div className="w-10 h-10 rounded-full bg-red-900/50 flex items-center justify-center shrink-0">
                                    ...
                                    <div>
                                        <strong className="block text-red-300 mb-1">Plugin Vulnerabilities</strong>
                                        <p className="text-sm text-red-200/50">Constant updates required. Prone to hacking, malware, and code conflicts.</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4">
                                    <div className="w-10 h-10 rounded-full bg-red-900/50 flex items-center justify-center shrink-0">
                                    ...
                                    <div>
                                        <strong className="block text-red-300 mb-1">Poor SEO Fundamentals</strong>
                                        <p className="text-sm text-red-200/50">Bloated HTML output triggers Google Lighthouse penalties, tanking rank.</p>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div
                        className="absolute inset-0 bg-blue-950/30 backdrop-blur-md flex flex-col justify-center p-8 md:p-16 lg:p-20 border-l border-cyan-400/50 shadow-[-20px_0_50px_rgba(34,211,238,0.15)]"
                        style={{ clipPath: `polygon(${sliderPosition}% 0, 100% 0, 100% 100%, ${sliderPosition}% 100%)` }}
                    >
                        <div className="w-[45%] md:w-[42%] max-w-[400px] absolute right-8 md:right-16 lg:right-20 text-right">
                            <h3 className="text-2xl md:text-4xl font-black text-cyan-400 mb-2 uppercase text-glow-cyan">Engineered Core</h3>
                            <h4 className="text-lg font-bold text-blue-300 mb-6 border-b border-cyan-500/20 pb-4">Next.js / React Architecture</h4>

                            <ul className="space-y-4 text-left">
                                <li className="flex items-start gap-4 flex-row-reverse">
                                    <div className="w-10 h-10 rounded-full bg-cyan-900/50 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(34,211,238,0.4)]">
                                        <Zap className="w-5 h-5 text-cyan-400" />
                                    </div>
                                    <div className="text-right">
                                        <strong className="block text-cyan-300 mb-1">Instant Edge Delivery</strong>
                                        <p className="text-sm text-blue-200/70">Pre-compiled HTML distributed to global edge nodes. 0.3s interaction times.</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4 flex-row-reverse">
                                    <div className="w-10 h-10 rounded-full bg-cyan-900/50 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(34,211,238,0.4)]">
                                    ...
                                    <div className="text-right">
                                        <strong className="block text-cyan-300 mb-1">Bulletproof Security</strong>
                                        <p className="text-sm text-blue-200/70">No databases exposed. No plugins. Serverless functions lock out intruders.</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4 flex-row-reverse">
                                    <div className="w-10 h-10 rounded-full bg-cyan-900/50 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(34,211,238,0.4)]">
                                    ...
                                    <div className="text-right">
                                        <strong className="block text-cyan-300 mb-1">AI-Ready SEO Schema</strong>
                                        <p className="text-sm text-blue-200/70">Perfect Lighthouse scores signal immense authority to Google's ranking algorithms.</p>
                                    </div>
                                </li>
                            </ul>
